...
public class CourseController {
  ...
  public Page<Course> getAllCourses(
      CourseFilterable courseFilterable, @PageableDefault(page = 0, size = 20) Pageable pageable) {
    return courseService.getCourses(courseFilterable, pageable);
  }
  ...
  @Operation(
      ...
      security = {@SecurityRequirement(name = OpenApiConfig.BEARER_AUTH_NAME)},
      description = "Search course by keyword in the name or archived position")
  @GetMapping("/search")
  @PageableQueryParams
  @RolesAllowed("SAILOR")
  ...
  @Operation(
      ...
      security = {@SecurityRequirement(name = OpenApiConfig.BEARER_AUTH_NAME)},
      description = "Force cancel a course by id")
  ...
  @Operation(
      ...
      security = {@SecurityRequirement(name = OpenApiConfig.BEARER_AUTH_NAME)},
      description = "Get all sailors enrolled in a course")
  @RolesAllowed("ADMIN")
  ...
  @Operation(
      ...
      security = {@SecurityRequirement(name = OpenApiConfig.BEARER_AUTH_NAME)},
      description = "Cancel registration for a course")
  ...
  @Operation(
      ...
      description = "Register for a course as a Sailor",
      security = {@SecurityRequirement(name = OpenApiConfig.BEARER_AUTH_NAME)},
      responses = {
  ...
  @Operation(
      ...
      security = {@SecurityRequirement(name = OpenApiConfig.BEARER_AUTH_NAME)},
      description = "Mark completation for a sailor")
