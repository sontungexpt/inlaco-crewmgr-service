...
public interface HttpSMSEventService {
  ...
  /**
   * Handle the event is emitted when an SMS fails to be sent out by the httpSMS app on your Android
   * phone
   *
   * @param request
   */
  ...
  /**
   * Handle the event is emitted when an SMS expires before being sent out by your Android phone. It
   ...
   * phone in the past 1 hour. The httpSMS app on your android phone sends a ping to the server ever
