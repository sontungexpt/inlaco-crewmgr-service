...
// import
// com.inlaco.crewmgrservice.feature.crew.infrastructure.persistence.mongodb.entity.CrewProfileEntity;
...
//   public CrewMobilizationScheduleResponse findDetailSchedule(String id) {
...
//         .aggregate(aggregation, AssignedMobilization.class,
// CrewMobilizationScheduleResponse.class)
...
//         mongoTemplate
//             .aggregate(
//                 newAggregation(operations), AssignedMobilization.class,
// ScheduleFacetResult.class)
//             .getUniqueMappedResult();
