...
//     eventPublisher.publishEvent(new NewCrewMobilizationScheduleEvent(this, newSchedule));
//     return newSchedule;
//   }
...
//   @Override
//   public CrewMobilizationScheduleResponse findDetailScheduleById(String id) {
//     return customScheduleRepository.findDetailSchedule(id);
//   }

//   @Override
//   public CrewMobilizationScheduleResponse updateSchedule(String id, JsonNode patch) {
