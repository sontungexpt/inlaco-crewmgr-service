...
//    // When
//    ApiKeyEntity entity = mapper.toApiKeyEntity(testDomain);
//
//    // Then
...
//
//    // When
//    ApiKey domain = mapper.toApiKey(entity);
//
//    // Then
...
//
//    // When
//    mapper.updateFromApiKey(existingEntity, updateData);
//
//    // Then
...
//
//    // When
//    ApiKeyEntity entity = mapper.toApiKeyEntity(domainWithNulls);
//
//    // Then
//    assertNull(entity.getId(), "ID should be null for MongoDB auto-generation");
