...
class ApiKeyManagementControllerTest {
    ...
    void createApiKeyWithTotp_WithValidRequest_ShouldCreateApiKey() throws Exception {
        ...
        when(apiKeyGenerationService.generateNewWithTotp(eq(request), eq(userId)))
        ...
        verify(apiKeyGenerationService).generateNewWithTotp(eq(request), eq(userId));
    ...
    void getApiKeySecretWithTotp_WithValidCode_ShouldReturnSecret() throws Exception {
        ...
        when(apiKeyGenerationService.verifyTotpForSecretViewing(eq(userId), eq("123456"), eq("purpose123")))
                .thenReturn(true);
        ...
        verify(apiKeyGenerationService).verifyTotpForSecretViewing(eq(userId), eq("123456"), eq("purpose123"));
    ...
    void getApiKeySecretWithTotp_WithInvalidCode_ShouldReturnBadRequest() throws Exception {
        // Given
        when(apiKeyGenerationService.verifyTotpForSecretViewing(eq(userId), eq("invalid"), eq("purpose123")))
                .thenReturn(false);
        ...
        verify(apiKeyGenerationService).verifyTotpForSecretViewing(eq(userId), eq("invalid"), eq("purpose123"));
