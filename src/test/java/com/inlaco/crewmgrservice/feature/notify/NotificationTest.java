...
//   private NotificationDispatcher notificationFactory;

//   @BeforeEach
//   void setup() {
//     when(notificationServiceMap.get(NotificationPolicy.SMS)).thenReturn(smsNotificationService);
//
// when(notificationServiceMap.get(NotificationPolicy.EMAIL)).thenReturn(emailNotificationService);

//     // Inject map mock vào NotificationFactory
//     notificationFactory = new NotificationDispatcher(notificationServiceMap);
//   }
